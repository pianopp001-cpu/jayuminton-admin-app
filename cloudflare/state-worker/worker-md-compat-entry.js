...
const OWN_COMPAT=new Set(['mdAutoAssignTargets','autoFillCourt','autoFillWaitGroup','moveOrSwapMember','assignWaitGroupToCourt','removeFromCourt','removeFromWaitGroup','swapCourts','swapWaitGroups','adjustCourtMembers','adjustWaitGroupMembers']);
