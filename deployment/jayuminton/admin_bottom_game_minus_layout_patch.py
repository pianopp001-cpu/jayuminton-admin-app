...
MARKER = 'jmAdminFixedQuickMenuV20874'
if MARKER in html:
...
(function(){
'use strict';
if(window.__jmAdminFixedQuickMenuV20874)return;
window.__jmAdminFixedQuickMenuV20874=true;
...
function ensure(){
  ...
  try{
    ...
    keepAutoInMemberToolbar();removeLegacyBottom();
