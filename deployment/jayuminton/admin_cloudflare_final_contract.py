...
#adminApp [data-role="voice-test"]{display:none!important;visibility:hidden!important;pointer-events:none!important}
...
#adminApp .member-vnext-badge.new-badge::before{content:'✨';font-size:8px!important;line-height:10px!important}
#adminApp .member-vnext-badge.new-badge small{font-size:8px!important;line-height:10px!important;font-weight:800!important}
...
(function(){
  ...
  function normalizeMemberBadges(app){
    app.querySelectorAll('.member-vnext-badge.new-badge').forEach(function(badge){
      if(badge.getAttribute('data-jm-new-normalized')==='1')return;
      badge.innerHTML='<small>신규</small>';
      badge.setAttribute('data-jm-new-normalized','1');
  ...
  function enforce(){
    ...
    if(!app)return;
    removeVoiceTestUi(app);
    normalizeMemberBadges(app);
