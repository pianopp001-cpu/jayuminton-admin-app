...
try {
  ...
  messaging.onBackgroundMessage((payload) => {
    ...
    const vibration = data.type === 'court_assignment' ? [1400,500,1400,500,1400] : [900,450,900,450,900];
    ...
    return (async () => {
      for (let repeatIndex = 0; repeatIndex < repeatCount; repeatIndex += 1) {
        ...
        if (repeatIndex + 1 < repeatCount) await new Promise((resolve) => setTimeout(resolve, 6500));
      }
    })();
  });
} catch (error) {
