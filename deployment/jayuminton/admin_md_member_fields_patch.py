...
marker = '__JAYUMINTON_ADMIN_MD_MEMBER_FIELDS_V1__'
if marker in html:
    raise SystemExit(0)
if '</body>' not in html:
...
addon = r'''
<style id="jayuminton-admin-md-member-fields-v1">
...
<script id="jayuminton-admin-md-member-fields-script-v1">
(function(){
  'use strict';
...
for req in (
    ...
    "if(name==='addMember')next[5]=meta()", "if(name==='updateMemberProfile')next[6]=meta()",
...
print('ADMIN_MD_MEMBER_FIELDS_V1_OK')
