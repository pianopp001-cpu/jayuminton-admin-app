...
rep('''      <input
      ...
      <input id="newPublicMemo" maxlength="40" placeholder="메모(선택, 예: 생일 8/21)">
...
# Add +1 beside every admin -1 control, preserving old -1 and reset.
...
# Bundle actions near selected-person controls.
