...
/* The base app ALREADY carries a hidden, higher-specificity cascade for
   ...
   selector adds. */
function ensureQuickRosterGridStyle(){if(document.getElementById('jmQuickRosterGridV1'))return;var style=document.createElement('style');style.id='jmQuickRosterGridV1';style.textContent='#adminApp #quickActiveRoster.v4-quick-roster{grid-template-columns:repeat(5,minmax(0,1fr))!important;gap:4px!important;align-items:start!important}#adminApp #quickActiveRoster.v4-quick-roster .quick-member.is-new-member{grid-column:auto!important;width:auto!important}#adminApp #quickActiveRoster.v4-quick-roster .quick-member{padding:4px 3px!important;min-height:40px!important;height:auto!important;overflow:visible!important;gap:2px!important}#adminApp #quickActiveRoster.v4-quick-roster .quick-member-name{overflow:visible!important;white-space:normal!important;overflow-wrap:anywhere!important;word-break:keep-all!important;font-size:clamp(8.5px,2.3vw,11px)!important;line-height:1.2!important;height:auto!important;max-height:none!important}#adminApp #quickActiveRoster.v4-quick-roster .quick-member-games{font-size:6.5px!important;margin-top:-1px!important}#adminApp #quickActiveRoster.v4-quick-roster .member-info-detail{white-space:normal!important;overflow:visible!important;text-overflow:clip!important;overflow-wrap:anywhere!important;word-break:keep-all!important;height:auto!important;font-size:6.5px!important;margin-top:1px!important}#adminApp #quickActiveRoster.v4-quick-roster .member-vnext-memo{font-size:6.5px!important;white-space:normal!important}#adminApp #quickActiveRoster.v4-quick-roster .member-vnext-badge.new-badge{position:static!important;display:inline-flex!important;width:auto!important;margin:1px auto 0!important;padding:1px 3px!important;font-size:6.5px!important;box-shadow:none!important}';(document.head||document.documentElement).appendChild(style);}
...
function maintain(){try{fixCheckOverlap();}catch(_){}try{fixNewBadges();}catch(_){}try{fixBottomBar();}catch(_){}try{fixExcludedNames();}catch(_){}try{fixDuplicateNameDisplay();}catch(_){}try{fixGlobalCompactName();}catch(_){}try{ensureQuickRosterGridStyle();}catch(_){}try{installLongPressScrollCancel();}catch(_){}}
