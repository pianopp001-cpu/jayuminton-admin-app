(function installJayumintonCloudflareV6Bridge(){
  ...
  if(typeof IS_ADMIN!=='undefined'&&IS_ADMIN){
    ...
    function handlePairClick(event){
      ...
      var first={id:pendingPair.id,card:pendingPair.card};
