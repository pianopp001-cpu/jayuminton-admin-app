...
patches=[
 ...
 HERE/'admin_vnext_member_fields_patch.py', HERE/'admin_vnext_ui_patch.py', HERE/'admin_vnext_script_patch.py', HERE/'admin_vnext_fast_save_patch.py', HERE/'v3_admin_overlay_guarantee.py', HERE/'admin_vnext_badge_cleanup_patch.py',
 HERE/'admin_vnext_multiselect_patch.py', HERE/'admin_vnext_partial_court_ui_patch.py', HERE/'admin_vnext_recent_played_ui_patch.py', HERE/'admin_vnext_transition_alert_patch.py', HERE/'admin_vnext_empty_court_patch.py', HERE/'admin_finish_fast_return_patch.py', HERE/'admin_fast_state_return_patch.py', HERE/'admin_md_ui_cleanup_patch.py', HERE/'admin_excluded_always_visible_patch.py',
]
...
print('[admin-vNext] admin-only patches verified: blocking save overlay, empty-court finish, member-only alerts, fast add/finish/all-mutation state returns, notification contract, recent-play statistic, Korean 신규 badge and UI')
