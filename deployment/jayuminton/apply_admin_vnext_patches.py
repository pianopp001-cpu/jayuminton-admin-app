...
patches=[
 ...
 HERE/'admin_vnext_member_fields_patch.py', HERE/'admin_vnext_ui_patch.py', HERE/'admin_vnext_script_patch.py', HERE/'admin_vnext_badge_cleanup_patch.py',
...
print('[admin-vNext] all admin-only patches including notification contract, recent-play statistic, clean Korean 신규 badge and UI verified successfully')
