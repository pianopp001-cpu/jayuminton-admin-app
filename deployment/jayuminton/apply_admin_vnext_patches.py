...
print('[admin-vNext] admin-only patches verified: empty-court finish, member-only alerts, fast add/finish/all-mutation state returns, notification contract, recent-play statistic, Korean 신규 badge and UI')
