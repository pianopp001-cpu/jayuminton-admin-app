...
required_admin=['id="newIsNew"','id="newIsSponsor"','id="newPublicMemo"','게임횟수 +1','>자동배정</button>','admin-vnext-bottom-bar','mobile-refresh-button','id="pairStatisticsModal"','id="pairStatisticsList"','__JAYUMINTON_ADMIN_MD_UI_CLEANUP_V1__']
