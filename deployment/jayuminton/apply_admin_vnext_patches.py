...
patches=[
 ...
 HERE/'admin_vnext_multiselect_patch.py', HERE/'admin_vnext_partial_court_ui_patch.py', HERE/'admin_vnext_recent_played_ui_patch.py', HERE/'admin_vnext_transition_alert_patch.py', HERE/'admin_vnext_empty_court_patch.py',
]
...
print('[admin-vNext] all admin-only patches including empty-court finish, transition vibration alert, fast save, notification contract, recent-play statistic, clean Korean 신규 badge and UI verified successfully')